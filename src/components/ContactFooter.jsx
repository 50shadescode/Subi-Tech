...
export default function ContactFooter() {
  ...
  return (
    <footer id="contact" className="mx-auto max-w-5xl px-6 pt-20 pb-12 border-t border-slate-900">
      ...
      {/* Part 1: High-Intent Action Panel Grid */}
      <div className="text-center max-w-3xl mx-auto mb-16">
        <p className="text-xs font-bold tracking-widest text-emerald-400 uppercase">Engagement</p>
        ...
        <p className="text-sm text-slate-400 mt-4 max-w-xl mx-auto">
          Whether you have a rough layout outline, a half-built system prototype, or a messy dataset, let's engineer the next phase.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-24">
        ...
        >
          ...
          <h3 className="text-lg font-bold text-white mb-1">Chat Directly</h3>
          <p className="text-xs text-slate-400 mb-4">Best for rapid structural diagnostics or immediate scope inquiries.</p>
        ...
        >
          ...
          <h3 className="text-lg font-bold text-white mb-1">Send a Brief</h3>
          <p className="text-xs text-slate-400 mb-4">Have an architectural scope checklist? Route it directly to our studio evaluation queue.</p>
        ...
        >
          ...
          <h3 className="text-lg font-bold text-white mb-1">Book a Call</h3>
          <p className="text-xs text-slate-400 mb-4">Lock in a clean 30-minute system alignment review window directly on our timeline grid.</p>
